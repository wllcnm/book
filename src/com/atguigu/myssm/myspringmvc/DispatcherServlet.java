...
import com.atguigu.myssm.util.ParameterNameUtil;
        ...
        try {
            ...
            for (Method method : methods) {
                if (operate.equals(method.getName())) {
                    //1.统一获取请求参数
                    List<String> parameterNameJava8 = ParameterNameUtil.getParameterNameJava8(controllerBeanObj.getClass(), method.getName());
                    parameterNameJava8.forEach(System.out::println);
